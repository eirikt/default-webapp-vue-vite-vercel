...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" :height="selectedHeight" :width="selectedWidth" viewBox="0 0 219 92">
        <defs>
            <clipPath id="a">
        ...
        <path style="stroke:none;fill-rule:nonzero;fill:#362701;fill-opacity:1"
